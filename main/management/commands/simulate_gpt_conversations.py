...
class Command(BaseCommand):
    help = "Simulate 100 GPT-to-GPT conversations and save answers"

    def handle(self, *args, **kwargs):
        question =( 
        "Imagine you are a international food enthusiast, List your top 3 favourite foods as a comma-separated line. "
        "Do NOT pick common items Be as creative and diverse as possible. "
        ...
        for i in range(100):
            ...
            # Parse the response to extract foods and type safely
        ...
        self.stdout.write(self.style.SUCCESS("100 conversations saved!"))
